...
export function spawnSubprocess(spec: SubprocessSpawnSpec, internals: SpawnInternals = {}): LocalSubprocessHandle {
  ...
  const child = spawn(program, args, {
    ...
    // Windows: never allocate a fresh console for a console-subsystem child.
    // Without this, every tool call made from a windowless daemon flashes a
    // cmd/conhost window and steals IME focus (observed live 2026-08-26).
