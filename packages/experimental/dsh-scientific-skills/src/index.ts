/**
 * @dsh-external/dsh-scientific-skills — 工具包形态（由 dev_scaffold_plugin 生成）。
...
export const name = "@dsh-external/dsh-scientific-skills"
...
export function apply(ctx: Context, config: Config): void {
  ...
  ctx.effect(() => ctx.tools.register(defineTool({
    name: '_dsh_external_dsh_scientific_skills_hello',
    description: "Loads and executes scientific-agent-skills (163 skills) as DSH tools",
    parameters: {
  ...
  })), '@dsh-external/dsh-scientific-skills: hello tool')
  ...
  //   const MINE = new Set(['_dsh_external_dsh_scientific_skills_hello'])
  //   const CORE = '<核心工具>'
